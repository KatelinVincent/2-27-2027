...
function BotanicalSVG({ style }) {
  return (
    ...
    >
      <path
        d="M80,280 Q60,200 120,150 Q160,110 140,50"
        stroke="#7A8C6E"
        strokeWidth="1.5"
        fill="none"
      />
      ...
      <ellipse
        ...
        ry="17"
        fill="#7A8C6E"
        transform="rotate(-50 140 110)"
      />
      <circle cx="140" cy="50" r="12" fill="#8A9BAD" />
      <path
        d="M50,270 Q30,220 70,180 Q100,150 85,100"
        stroke="#7A8C6E"
        strokeWidth="1"
        fill="none"
      />
  ...
  return (
    ...
    >
      ...
      >
        Jacob
        <br />
        <span style={{ color: "var(--linen-dark)" }}>&</span>
        <br />
        Kate
      </h1>
      ...
      >
        <div
          style={{ flex: 1, height: "0.5px", background: "var(--linen-dark)" }}
        />
        <span style={{ color: "var(--sage-light)", fontSize: "0.7rem" }}>
          N
        </span>
        <div
          style={{ flex: 1, height: "0.5px", background: "var(--linen-dark)" }}
      ...
      >
        ...
        <div
          style={{
            ...
            height: "40px",
            background:
              "linear-gradient(to bottom, var(--linen-dark), transparent)",
